 ...
 */
export default function Navbar({ handleInput, onHandleInputChange, onImportSubmit, isLoading }) {
  return (
    <header className="bg-gray-950 border-b border-gray-800 px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
      ...
      <div>
        ...
        <p className="text-xs text-gray-500">Real-time Codeforces stats & insights</p>
      </div>
